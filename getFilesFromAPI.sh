...
curl "https://api.unibit.ai/companyprofile/AAPL?AccessKey=demo" | jq '. | {ticker: ."company profile".ticker, company_name: ."company profile".company_name, exchange: ."company profile".exchange}' > data/companyprofile/json/AAPL_profile.json
